...
class _PedidosEnPreparcionTiendaState extends State<PedidosEnPreparcionTienda> {
  ...
  Widget build(BuildContext context) {
    ...
    List list = context.watch<GetPedidosProvider>().atStoreBeingPrepared;
    ...
    return Scaffold(
        body: SafeArea(child:Column(children: [
          ...
          UsedWidgets().buildListTileForTitle(leadingIcon:Icons.storefront_sharp,
              voidCallback: (){  Navigator.of(context).pushNamed(PedidosEnPreparcionTienda.id);}, title:'En Preparacion'  ),
          Divider(thickness: 2,),
                  ...
                  children: [SizedBox(height: 10,),
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          primary: Colors.red, textStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      onPressed: () async{
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [ElevatedButton(style: ElevatedButton.styleFrom(primary: Color(0xff009B77),
                          ...
                          ElevatedButton(
                            ...
                            child:iSloadingChangeStatus==false? Text('Listo'):Text('cargando...'),
                          )],
                      ),
                    ),
                  ],
