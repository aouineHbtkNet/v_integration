...
class PedidosEnPreparcionDomicilio extends StatefulWidget {
  static const String id = '/PedidosEnPreparcionDomicilio';
...
class _PedidosEnPreparcionDomicilioState extends State<PedidosEnPreparcionDomicilio> {
  ...
  Widget build(BuildContext context) {
    ...
    List list = context.watch<GetPedidosProvider>().aldomicilioBeingprepared;
                        ...
                        children: [ElevatedButton(style: ElevatedButton.styleFrom(primary: Color(0xff009B77),
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              int orderId = list[index]['id'];
                              await ModifyStatus().modifySatatus(orderId,'En Camino');
                              await context.read<GetPedidosProvider>().getAllOrderList();
                              setState(() {iSloadingChangeStatus=false;});

                            },
                            child:iSloadingChangeStatus==false? Text('En Camino'):Text('cargando...'),
                          )],
                      ),
                    ),
                  ],
