...
class PedidosRecividosDomicilio extends StatefulWidget {
  static const String id = '/PedidosRecividosDomicilio';
...
class _PedidosRecividosDomicilioState extends State<PedidosRecividosDomicilio> {
  ...
  Widget build(BuildContext context) {
    ...
    List list = context.watch<GetPedidosProvider>().aldomicilioReceived;
    ...
    return Scaffold(
        body: SafeArea(child:Column(children: [
          ...
          UsedWidgets().buildListTileForTitle(leadingIcon:Icons.delivery_dining ,
              voidCallback: (){  Navigator.of(context).pushNamed(PedidosRecividosDomicilio.id);}, title:'Recibidos'  ),
          Divider(thickness: 2,),
