...
class PedidosPendientesDomicilio extends StatefulWidget {
  static const String id = '/PedidosPendientesAldomcilio';
...
class _PedidosPendientesDomicilioState extends State<PedidosPendientesDomicilio> {
  ...
  List <String> statusList =['Recibido','En preparacion','En camino','Entregado'];
  ...
  Widget build(BuildContext context) {
    ...
    List list = context.watch<GetPedidosProvider>().aldomicilioPendientes;
