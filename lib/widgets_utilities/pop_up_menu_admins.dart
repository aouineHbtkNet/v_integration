...
class PopUpMenuWidgetAdmins extends StatelessWidget {

  bool  putArrow =false;

  final VoidCallback? callbackArrow;
   PopUpMenuWidgetAdmins({Key? key ,
    required this.putArrow, this.callbackArrow,
  }) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return  PopupMenuButton(
        ...
        onSelected: (value) async {
          ...
          if (value == 2) {
            Navigator.of(context).pushNamedAndRemoveUntil(AdminProfileScreen .id, (route) => false);
          }
